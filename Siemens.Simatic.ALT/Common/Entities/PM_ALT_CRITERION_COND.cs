...
{
    /// <summary>
    /// PM_ALT_CRITERION_COND Class.
    /// </summary>
    /// Title: PM_ALT_CRITERION_COND
    /// Copyright: LiXiao Info Tech Ltd.
    /// Version: 1.0
    [Serializable]
    public class PM_ALT_CRITERION_COND : PersistentPM_ALT_CRITERION_COND
    {
    }
}
...
{
    /// <summary>
    /// PM_ALT_CRITERION_COND PersistentClass.
    /// </summary>
    /// Title: PersistentPM_ALT_CRITERION_COND
    /// Copyright: LiXiao Info Tech Ltd.
    /// Version: 1.0
    [Serializable]
    public class PersistentPM_ALT_CRITERION_COND : BaseEntity
    {
        public PersistentPM_ALT_CRITERION_COND()
            : base()
        {
