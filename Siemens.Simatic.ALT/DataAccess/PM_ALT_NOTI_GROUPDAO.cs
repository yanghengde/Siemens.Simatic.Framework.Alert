...
{
    [DefaultImplementationAttreibute(typeof(DefaultImpl.PM_ALT_NOTI_GROUPDAO))]
    public interface IPM_ALT_NOTI_GROUPDAO : IDataAccessor<PM_ALT_NOTI_GROUP>
    {
    }
}
...
{
    /// Title: PM_ALT_NOTI_GROUPDAO
    /// Copyright: LiXiao Info Tech Ltd.
    /// Version: 1.0  
    public partial class PM_ALT_NOTI_GROUPDAO : IPM_ALT_NOTI_GROUPDAO
    {

        #region SQl
        #region SqlInsert
        private const string SqlInsert = @"INSERT INTO dbo.PM_ALT_NOTI_GROUP (
                                                [NotiGroupID],
                                                [GroupName],
                                                [GroupDesc],
                                                [NotiEmail],
        ...
        #region SqlDelete
        private const string SqlDelete = @"DELETE FROM dbo.PM_ALT_NOTI_GROUP 
                                           WHERE 1 = 1 
                                           AND NotiGroupID = @NotiGroupID";
        #endregion

        #region SqlUpdateAll
        private const string SqlUpdate = @"UPDATE dbo.PM_ALT_NOTI_GROUP SET
                                            [GroupName] = @GroupName,
                                            [GroupDesc] = @GroupDesc,
                                            [NotiEmail] = @NotiEmail,
                                            [NotiSMS] = @NotiSMS,
        ...
        /// </summary>  
        public PM_ALT_NOTI_GROUP Insert(PM_ALT_NOTI_GROUP entity, DbTransaction transaction)
        {
            ArgumentValidator.CheckForNullArgument(entity, "entity");
        ...
        public void Delete(object entityId)
        {
            ...
            {
                Database db = GetDatabaseInstance();
                DbCommand dbCommand = db.GetSqlStringCommand(PM_ALT_NOTI_GROUPDAO.SqlDelete);
        ...
        /// Get
        /// </summary>
        public PM_ALT_NOTI_GROUP Get(object entityId)
        {
            ArgumentValidator.CheckForNullArgument(entityId, "entityId");
        ...
        private void UpdateAll(PM_ALT_NOTI_GROUP entity)
        {
            ArgumentValidator.CheckForNullArgument(entity, "entity");
        ...
        private void UpdateSome(PM_ALT_NOTI_GROUP entity)
        {
            ArgumentValidator.CheckForNullArgument(entity, "entity");
        ...
        private void LoadMappings()
        {
            ...
            entityMapping.Name = "PM_ALT_NOTI_GROUP";
            entityMapping.TableName = "dbo.PM_ALT_NOTI_GROUP";
        ...
        {
            new object[] {"NotiGroupID", DbType.Guid, false, true, "NotiGroupID",typeof(Guid?)},
            new object[] {"GroupName", DbType.String, false, false, "GroupName",typeof(String)},
            new object[] {"GroupDesc", DbType.String, true, false, "GroupDesc",typeof(String)},
            new object[] {"NotiEmail", DbType.Boolean, false, false, "NotiEmail",typeof(Boolean?)},
            new object[] {"NotiSMS", DbType.Boolean, false, false, "NotiSMS",typeof(Boolean?)},
        ...
        /// Find
        /// </summary>
        public IList<PM_ALT_NOTI_GROUP> Find(int pageIndex, int pageSize, IFilter filter, ISort sort, out long totalRecords)
        {
            if (pageIndex < 0)
            {
            ...
            IList<PM_ALT_NOTI_GROUP> PM_ALT_NOTI_GROUPList = new List<PM_ALT_NOTI_GROUP>();
            totalRecords = 0;
            ...
            if (pageSize == -1)
            {
                ...
                CultureInfo.InvariantCulture, PM_ALT_NOTI_GROUPDAO.SqlSelectAll, filterClause, sortClause);
            }
            else
            {
                cmdText = String.Format(
                       CultureInfo.InvariantCulture,
                       PM_ALT_NOTI_GROUPDAO.SqlSelect, pageSize.ToString(), filterClause, beginIndex.ToString(), filterClause, sortClause, sortClause);
            }
            ...
            try
            {
                ...
                if (pageSize != 0)
                {
                    ...
                    using (IDataReader dataReader = db.ExecuteReader(dbCommand))
                    {
                        ...
                        {
                            PM_ALT_NOTI_GROUPList.Add(ReadEntity(dataReader));
                        }
                    }
                }
            ...
            return PM_ALT_NOTI_GROUPList;
        }

        /// <summary>
        /// Find with transaction
        /// </summary>
        public IList<PM_ALT_NOTI_GROUP> Find(int pageIndex, int pageSize, IFilter filter, ISort sort, out long totalRecords, DbTransaction transaction)
        {
            ArgumentValidator.CheckForNullArgument(transaction, "transaction");
